...
public class Member_Course_Adapter extends ArrayAdapter{
    private int resource;
    public Member_Course_Adapter(Context context, int resource, List objects) {
        ...
        if (convertView == null) {
            ...
            viewHolder.courseRead.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {                        // TODO Auto-generated method stub
                    //进入课程详细信息界面（可购买课程
                    Intent intent = new Intent(getContext(),Member_Course_Info.class);
