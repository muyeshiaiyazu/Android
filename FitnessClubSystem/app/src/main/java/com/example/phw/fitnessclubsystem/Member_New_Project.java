...
public class Member_New_Project extends Fragment {
    private Member_Course_Adapter adapter = null;
    private List list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Classinit();
        View view = inflater.inflate(R.layout.member_new_project, container, false);
        listView = (ListView) view.findViewById(R.id.list_course);
        adapter = new Member_Course_Adapter(getActivity(), R.layout.member_course_list_item, list);
