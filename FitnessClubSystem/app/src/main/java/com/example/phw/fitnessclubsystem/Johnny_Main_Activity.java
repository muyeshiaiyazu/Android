...
public class Johnny_Main_Activity extends AppCompatActivity implements View.OnClickListener {
    //声明ViewPager
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.johnny_main);
    ...
    private void initDatas() {
        ...
        //将四个Fragment加入集合中
        mFragments.add(new Johnny_Club_News());
        mFragments.add(new Johnny_New_Project());
        mFragments.add(new Johnny_Mine());
