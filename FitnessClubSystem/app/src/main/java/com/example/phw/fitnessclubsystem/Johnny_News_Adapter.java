...
public class Johnny_News_Adapter extends ArrayAdapter {
    private int resource;

    public Johnny_News_Adapter(Context context, int resource, List objects) {
        ...
        if (convertView == null) {
            ...
            viewHolder.newsRead.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {                        // TODO Auto-generated method stub
                    //进入新闻详细信息界面
                    Intent intent = new Intent(getContext(),Johnny_News.class);
