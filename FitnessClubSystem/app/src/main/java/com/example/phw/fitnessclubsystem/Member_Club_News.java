...
public class Member_Club_News extends Fragment {
    private Member_News_Adapter adapter = null;
    private List list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new Member_News_Adapter(getActivity(), R.layout.news_list_item, list);
